// 자바스크립트는 함수를 특별한 종류의 값으로 취급합니다. 다른 언어에서처럼 "특별한 동작을 하는 구조"로 취급 되지 않습니다.
...
// 위 예시를 간단한 말로 풀면 다음과 같습니다: "함수를 만들고 그 함수를 변수 sayHi에 할당하기" 함수는 값이기 때문에 alert를 이용하여 함수 코드를 출력할 수도 있습니다.
function sayHi() {
  alert( "Hello" );
}
...
// 함수는 sayHi처럼 호출할 수 있다는 점 때문에 일반적인 값과는 조금 다른 특별한 종류의 값입니다.
...
// 콜백 함수: 함수를 값처럼 전달하는 예시, 함수 표현식에 관한 예시를 좀 더 살펴보겠습니다.
...
// 함수 표현식 vs 함수 선언문: 함수 표현식과 선언문의 차이에 대해 알아봅니다.
...
// if문 밖에서 welcome 함수를 호출할 방법은 함수 표현식을 사용하면 가능합니다. if문 밖에 선언한 변수 welcome에 함수 표현식으로 만든 함수를 할당하면 되죠.
